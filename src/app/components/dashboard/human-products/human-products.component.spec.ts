...
import { HumanProductsComponent } from './human-products.component';
import { ProductService } from '../../../services/product.service';
import { Router } from '@angular/router';
import { of, throwError } from 'rxjs';
import Swal from 'sweetalert2';

describe('HumanProductsComponent', () => {
  let component: HumanProductsComponent;
  let fixture: ComponentFixture<HumanProductsComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [HumanProductsComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(HumanProductsComponent);
  ...
  it('should navigate to add product page', () => {
    ...
    expect(router.navigate).toHaveBeenCalledWith(['/dashboard/add-human-product']);
  });

  it('should navigate to edit product page', () => {
    const product = mockProducts[0];
    component.editProduct(product);
    expect(router.navigate).toHaveBeenCalledWith(['/dashboard/edit-human-product', product.id]);
  });
